...
discounted_price = original_price * 20 / 100
...
radius = 3.5
pi = 3.14
area_of_the_flowerbed = pi * radius ** 2
print(area_of_the_flowerbed)
...
print(int(chips_in_each_cookie))
remaining_chips = chocolate_chips - (chips_in_each_cookie * cookies)
